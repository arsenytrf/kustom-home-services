            ...
            <ScrollReveal key={service.slug} delay={index * 0.08}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-display text-lg sm:text-xl md:text-2xl font-bold text-slate-900 group-hover:text-teal-600 transition-colors duration-300">
                    {service.title}
                  </h3>
                  <p className="mt-1 text-sm sm:text-base text-slate-500 group-hover:text-slate-600 transition-colors duration-300 line-clamp-2">
                    {service.description}
                  </p>
                </div>
