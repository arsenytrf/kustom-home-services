  ...
  return (
    <html lang="en" className="h-full">
      ...
      <body className="font-body antialiased bg-white text-slate-900 min-h-full flex flex-col noise-overlay">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[9999] focus:bg-teal-500 focus:text-white focus:px-4 focus:py-2 focus:font-body focus:font-semibold"
        >
